...
if (isset($_GET['id_encuesta'])) {
    ...
    if (isset($_SESSION['desactivado'][$idEncuesta])) {
      echo "<div class='container' style='display: flex; flex-direction: column; justify-content: center; align-items: center; border-collapse: collapse;'>";
      echo "<div class='alert alert-warning' role='alert' style='background-color: #808080; color: white;'>";
      echo "<h3>Esta encuesta no se encuentra activa.</h3>";
      echo "</div>";        
      exit();
    }
} else {
    die("El parámetro id_encuesta no está definido");
}
?>


<?php include "insertar_dinamico.php";?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
